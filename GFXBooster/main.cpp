...
{ // This block ensures C-style (unmangled) names for the linker
    ...
    F4SE_API bool F4SEPlugin_Load(const F4SE::LoadInterface *f4se) {
        ...
        // CommonLibF4's F4SE::Init takes only the LoadInterface* in current versions.
        F4SE::Init(f4se);
        // Log information
        REX::INFO("{}: Plugin loaded!", Version::PROJECT);
        // Some CommonLibF4 branches do not expose `F4SE::GetF4SEVersion()`.
        // Keep this optional to maximize compatibility.
